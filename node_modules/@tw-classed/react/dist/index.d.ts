...
export { InferVariantProps } from '@tw-classed/core';
 ...
 */
interface ClassedComponentType<Type extends keyof JSX.IntrinsicElements | AnyComponent, Props extends {} = {}, TComposedVariants extends {} = {}> extends ForwardRefComponent<Type, Props> {
    [$$ClassedProps]: Props;
 ...
 */
type DerivedComponentType<Type extends keyof JSX.IntrinsicElements | React.ComponentType<any>, Props extends {} = {}, TComposedVariants extends {} = {}> = ClassedComponentType<Type, Omit<Props, "as">, TComposedVariants>;
...
interface ClassedFunctionType {
    <Type extends keyof JSX.IntrinsicElements | AnyComponent, Composers extends (string | Function | {
        base?: string;
        variants?: {
            [name: string]: unknown;
        };
 ...
 */
interface ClassedProxyFunctionType<Type extends keyof JSX.IntrinsicElements | AnyComponent> {
...
interface DeriveClassedFunction {
    <Type extends ClassedComponentType<any>, Props extends {} = React.ComponentProps<Type>, As extends keyof JSX.IntrinsicElements | unknown = unknown>(callback: React.ForwardRefRenderFunction<React.ComponentRef<As extends keyof JSX.IntrinsicElements ? As : Type>, React.PropsWithoutRef<As extends keyof JSX.IntrinsicElements ? Merge<Omit<Props, "as">, React.ComponentProps<As>> : Props>>): DerivedComponentType<Type, React.PropsWithoutRef<As extends keyof JSX.IntrinsicElements ? Merge<Props, React.ComponentProps<As>> : Props>>;
}
declare const deriveClassed: DeriveClassedFunction;

export { ClassedComponentType, ClassedConfig, ClassedFunctionProxy, ClassedFunctionType, ClassedProxyFunctionType, ComponentProps, DeriveClassedFunction, DerivedComponentType, StrictComponentType, VariantProps, classedProxy as classed, createClassed, deriveClassed, makeStrict };

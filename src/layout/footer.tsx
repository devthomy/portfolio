    ...
    <footer id="footer">
      <div className="bg-primary-dark items-center">
        <div className="bg-primary-dark max-w-4xl mx-auto flex flex-col items-center">
          <div className="px-4 text-white sm:px-6 lg:px-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-br-dark py-4 sm:py-6 lg:py-10 justify-center">

            <div className="flex flex-col py-4 sm:py-2 lg:py-0 pl-2 lg:pl-0 mt-4 sm:mt-2 lg:mt-10 p-4 sm:p-6">
        ...
        <div className="bg-primary-grey flex p-4">
          <div className="flex items-center w-full flex-col text-white lg:flex-row justify-center text-br-lgreen pt-2 pb-2 text-sm">
